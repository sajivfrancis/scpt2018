...
if ((!empty($_GET['resetmd5'])) && (!empty($_GET['email']))) {
    ...
    if ($result['resetmd5'] == $_GET['resetmd5']) {
		...
		<link rel="apple-touch-icon" sizes="144x144" href="https://scpt.tk/img/apple-touch-icon.png">
                <link rel="icon" type="image/png" sizes="32x32" href="https://scpt.tk/img/favicon-32x32.png">
                <link rel="icon" type="image/png" sizes="16x16" href="https://scpt.yk/img/favicon-16x16.png">
                <link rel="manifest" href="https://scpt.tk/img/site.webmanifest">
                <link rel="mask-icon" href="https://scpt.tk/img/safari-pinned-tab.svg" color="#5bbad5">
            ...
            <body class="login">
                <div class="loginBox">
                    <img src="https://scpt.tk/img/user.png" class="user">
...
<body class="login">
    ...
    <div class="loginBox">
        <img src="http://localhost:8888/scpt/img/user.png" class="user">
